...
<div class="container mt-5 text-2xl font-bold">
    ...
    <div class="col-sm-8">
        ...
        <div class="card-body">
            ...
            <div class=" py-6 form-group flex flex-col">
                <label for="email" class = "font-bold px-6">Email</label>
    <input type="name" v-model="name" placeholder="JohnDoe@fiu.edu" class="h-10 border-2 border-blue-800 rounded px-2 ">
            </div>
            <div class="form-group flex flex-col">
                <label for="password" class ="px-2 font-bold" >Password</label>
             <input type="name" v-model="name" placeholder="Password123" class="h-10 border-2 border-blue-800 rounded px-2">
            </div>
            <button type="submit" class="my-5 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded ">Login</button>
            </form>
...
<div class=" py-5 bg-gray-200  flex justify-center items-center flex-col">
    
    <div class="bg-blue-600 text-red-100 hover:text-white shadow font-bold text-sm py-3 px-4 rounded flex justify-start items-center cursor-pointer w-64">
    ...
    <div class="bg-gray-900 text-gray-100 hover:text-white shadow font-bold text-sm py-3 px-4 rounded flex justify-start items-center cursor-pointer w-64 mt-2">
